...
<template>
  <div class="wrapper">
    ...
    <div class="info">
      ...
      <div class="login">
        <div class="username">公主殿下的忠犬</div>
        <div class="angel"></div>
      </div>
      ...
      >
        <path
          d="M312.17664 393.09312a20.48 20.48 0 1 0 0-40.96h-77.2096a20.48 20.48 0 0 0-20.48 20.48v449.55648a20.48 20.48 0 0 0 20.48 20.48h449.55648a20.48 20.48 0 0 0 20.48-20.48V745.0624a20.48 20.48 0 1 0-40.96 0v56.6272h-408.576V393.09312h56.70912z"
          fill="#ffffff"
          p-id="13088"
        ></path>
        <path
          d="M849.38752 187.31008H399.81056a20.48 20.48 0 0 0-20.48 20.48v449.55648a20.48 20.48 0 0 0 20.48 20.48h449.55648a20.48 20.48 0 0 0 20.48-20.48V207.79008a20.43904 20.43904 0 0 0-20.45952-20.48z m-20.48 449.55648H420.29056V228.27008h408.59648v408.59648z"
          fill="#ffffff"
          p-id="13089"
        ></path>
      </svg>
...
import Search from "@/components/content/searchCom/search.vue";
export default {
  components: {
    Search,
  },
